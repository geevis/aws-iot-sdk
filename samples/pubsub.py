...
if __name__ == '__main__':
    ...
    if args.message:
        ...
        while (publish_count <= args.count) or (args.count == 0):
            ...
            device_id = "raspberrypi-building01"
            if publish_count % 2 ==0:
               sensor_id = "sensor-01"
            else:
               sensor_id = "sensor-02"

            message = { "DeviceID": device_id,"SensorID":sensor_id,"Time":datetime.datetime.now().strftime("%m/%d/%Y,%H:%M:%S"),"Temperature":temperature_c,"Humidity":humidity,"Count":publish_count}
            #.format(device_id,sensor_id,datetime.datetime.now(), temperature_c, humidity, publish_count)
